  ...
  document.querySelector("#box" + i).onclick = () => {
    ...
    if (playing) {
      ...
      if (document.querySelector("#box" + i).innerHTML == correctAnswer) {
        ...
        score++;
        //set score value
        document.querySelector("#scorevalue").innerHTML = score; //shows score
...
function generateQA() {
  ...
  var k = 1 + Math.round(4 * Math.random());

  //correct answer and //setting question
  if (k == 1) {
    // for addition
    correctAnswer = x + y;
    ...
    if (x % y != 0) correctAnswer = (x / y).toFixed(3);
      ...
      do {
        if (k == 1)
          ...
          wrongAnswer =
            (1 + Math.round(9 * Math.random())) /
            (1 + Math.round(9 * Math.random()));
          if (x % y != 0) wrongAnswer = wrongAnswer.toFixed(3);
          else wrongAnswer = Math.round(wrongAnswer);
        }
